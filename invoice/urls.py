...
urlpatterns = [
    ...
    path('proforma/<slug:slug>/approval/', views.ProformaApprovalView.as_view()),
    path('proforma/<slug:slug>/status/', views.ProformaStatusUpdateView.as_view()),
    ...
    path('proforma/bulk_download/', views.BulkInvoiceDownloadView.as_view()),
